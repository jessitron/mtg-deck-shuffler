...
15. **The canonical pattern for adding a required `mtg-card` prop is now: edit `mtgCardShape()`
...
16. **A decoy/shadow shape can share a type with the real thing, distinguished by a prefixed
