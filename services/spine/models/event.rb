...
module Spine
  ...
  # order within the table's log. No trace-context column, in either
  # direction — trace context is observability-only and expires; it never
  # rides with durable causality data (contracts/README.md).
