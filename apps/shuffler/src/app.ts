...
export function createApp(
  ...
  app.post("/start-game", async (req, res) => {
    ...
    try {
      ...
      if (tableInfo) {
        await sendSeatJoinedBestEffort(tabletopPort, tableInfo.tableName, tableInfo.seatId, tableInfo.playerName, prep.deck.name);
      }
  ...
  app.get("/yo", async (req, res) => {
    ...
    try {
      ...
      await sendSeatJoinedBestEffort(tabletopPort, tableInfo.tableName, tableInfo.seatId, tableInfo.playerName, sortedDeck.name);
