...
commentary) lives in `DESIGN-event-contract-v0.md` — this doc restates the _current state_
...
```json
{
  ...
  "name": "table.created",
  "seq": 1,
  "acceptedAt": "2026-08-10T20:22:53.7Z",
...
```json
{
  ...
  "name": "seat.taken",
  "seq": 2,
  "acceptedAt": "2026-08-10T20:23:01.1Z",
  "initiator": { "playerName": "Jess" },
  "occurredIn": "spine",
  "visibility": "public",
  "traceparent": "00-1680bb...-01",
...
### `seat.joined` — a seat's _look_ arrives at the table (Tabletop-facing, richer)
...
Sent by: the Shuffler, on `/play-card`/`/discard-card`. The Shuffler _knows_ the meaning
...
- **Game event vs. physical event.** The Shuffler is deterministic and knows meaning →
  ...
  the Interpreter's readings) are a _separate_ category — reserved for genuinely ambiguous
