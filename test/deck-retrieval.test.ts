...
import { ArchidektDeck, ArchidektCard } from "../src/deck-retrieval/ArchidektTypes.js";
import { StandardArchidektDeckToDeckAdapter } from "../src/deck-retrieval/ArchidektDeckToDeckAdapter.js";

describe("StandardArchidektDeckToDeckAdapter", () => {
  const adapter = new StandardArchidektDeckToDeckAdapter();
  ...
  test("converts basic deck without commander", () => {
    ...
    const result: Deck = adapter.convert(archidektDeck);
  ...
  test("converts deck with commander", () => {
    ...
    const result = adapter.convert(archidektDeck);
  ...
  test("converts real Ygra deck data correctly", () => {
    ...
    const result = adapter.convert(ygraData);
