...
import { ArchidektDeckToDeckAdapter, convertArchidektToCard } from "../../src/deck-retrieval/archidekt-deck-to-deck-adapter.js";
import { ArchidektDeck, ArchidektCard } from "../../src/deck-retrieval/archidekt-types.js";
...
describe("ArchidektDeckToDeckAdapter", () => {
  const adapter = new ArchidektDeckToDeckAdapter();
  ...
  test("converts basic deck without commander", () => {
    ...
    const result: Deck = adapter.convertToDeck(archidektDeck);
  ...
  test("converts deck with commander", () => {
    ...
    const result = adapter.convertToDeck(archidektDeck);
  ...
  test("converts real Ygra deck data correctly", () => {
    ...
    const result = adapter.convertToDeck(ygraData);
